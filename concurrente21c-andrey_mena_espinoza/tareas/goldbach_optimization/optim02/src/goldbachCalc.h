...
typedef struct shared_data {
  ...
  uint64_t position;
  pthread_mutex_t can_acces_position;
} shared_data_t;
...
/**
 * @brief Funcion que se encarga de crear hilos y asignar su rango de trabajo
 * @param shared_data
 * @param private_data
 * @param threads
 * @return int
...
/**
 * @brief Funcion que se encarga hacer join (wait) a los hilos
 * @param shared_data
 * @param threads
 * @return int
*/
...
/**
 * @brief Funcion inicial que ejecuta cada hilo, los redirige a calcular
 *        los numeros que le fueron asignados.
 * @param data
 * @return void*
*/
